...
template <typename DataType>
inline Iterator <DataType> DynamicStack <DataType>::begin ()

{

	return Iterator <DataType> (getData (data_, 0));

}

template <typename DataType>
inline Iterator <DataType> DynamicStack <DataType>::end ()

{

	return Iterator <DataType> (getData (data_, length_ - 1));

}

template <typename DataType>
DataType & DynamicStack <DataType> ::operator [] (size_t index)
